...
usage() {
  ...
  echo "Example: /project/GCRB/Banaszynski_lab/shared/scripts/ryan_scripts/other/downsample.sh -a 'sample.bam' -p 1  [-o '/path/to/output/dir/']"
  exit 1
}
